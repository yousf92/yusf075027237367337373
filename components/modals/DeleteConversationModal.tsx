...
const DeleteConversationModal: React.FC<DeleteConversationModalProps> = ({ onConfirm, onClose }) => {
  return (
    <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-[70] p-4">
      <div className="w-full max-w-sm bg-sky-950 border border-red-500/50 rounded-lg p-6 space-y-4 text-white">
        <h3 className="text-xl font-bold text-red-400 text-center">حذف المحادثة</h3>
        <p className="text-sky-200 text-center">سيؤدي هذا إلى حذف المحادثة من قائمتك. لن يتم حذفها من قائمة الطرف الآخر. هل أنت متأكد؟</p>
